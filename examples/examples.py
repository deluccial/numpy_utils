import numpy as np
from numpy_utils import hcat, vcat, add_dim, to_type, equals, make_array, make_constant
...
print('equals array=array: \n', (arr | equals | arr), split)
print('equals array=list: \n', (arr | equals | list(arr)), split)
print('equals tuple=list: \n', (tuple(arr) | equals | list(arr)), split)
